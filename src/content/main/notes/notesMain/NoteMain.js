...
import SavingMessage from '../notesMobile/SavingMessage';
...
const NoteMain = () => {
    ...
    return(
        ...
        <div id='mainNoteContainer'>
            <div id='mainNoteHeader'>
            ...
            <div id='mainNotePad'>
                <div contentEditable='true' dangerouslySetInnerHTML={{__html: note.current.content}} onInput={handleChange} id='mainNoteTextArea' name='content'></div>
            </div>
        </div>
        </>
    )
